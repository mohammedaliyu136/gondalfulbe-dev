...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                {{Form::label('bank_account',__('Email'),['class'=>'form-label'])}}<x-required></x-required>
                {{Form::text('email',null,array('class'=>'form-control', 'required'=>'required', 'placeholder'=>__('Email')))}}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    {{ Form::select('collection_centre', $warehouses->pluck('name', 'id'), $selectedWarehouseId ?? null, ['class' => 'form-control', 'placeholder' => __('Select Collection Centre')]) }}
                </div>
            </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                {{ Form::label('cooperative_id', __('Cooperative'), ['class' => 'form-label']) }}
                {{ Form::select('cooperative_id', $cooperatives->pluck('name', 'id'), $vender->cooperative_id, ['class' => 'form-control select2', 'placeholder' => __('Select Cooperative (Optional)')]) }}
            </div>
        </div>
