...
@section('content')
        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="card pb-0 customer-detail-box vendor_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">Collection Centre: {{$vendor->collection_centre}}</p>
       ...
       <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="image-container text-center" style="max-width: 200px; overflow: hidden;">
                @if ($vendor->image)
                    ...
                    <img src="{{ asset('public/uploads/farmers/' . $vendor->image) }}" alt="{{ $vendor->name }}" class="img-fluid rounded" style="max-width: 100%; height: auto;">
                @else
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card pb-0">
                <div class="card-body">
                    <h5 class="card-title">{{__('Farmers Details')}}</h5>
                    <div class="row">
                        @php
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="p-4">
                                ...
                                <h6 class="report-text mb-3">{{\Auth::user()->priceFormat($vendor->book_balance)}}</h6>
