                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <!-- MONNIFY -->
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-2-37">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#collapse37" aria-expanded="false"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check form-switch custom-switch-v1">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="is_monnify_enabled"
                                                            id="is_monnify_enabled"
                                                            {{ isset($company_payment_setting['is_monnify_enabled']) && $company_payment_setting['is_monnify_enabled'] == 'on' ? 'checked' : '' }}>
                                            ...
                                            <div class="accordion-body">
                                                                        ...
                                                                        <div class="border card p-1">
                                                                            <div class="form-check">
                                                                                <label
                                                                                    class="form-check-label text-dark me-2">
                                                                                    <input type="radio"
                                                                                        name="monnify_mode" value="sandbox"
                                                                                        class="form-check-input"
                                                                                        {{ (isset($company_payment_setting['monnify_mode']) && $company_payment_setting['monnify_mode'] == '') || (isset($company_payment_setting['monnify_mode']) && $company_payment_setting['monnify_mode'] == 'sandbox') ? 'checked="checked"' : '' }}>
                                                                                    {{ __('Sandbox') }}
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="border card p-1">
                                                                            <div class="form-check">
                                                                                <label
                                                                                    class="form-check-label text-dark me-2">
                                                                                    <input type="radio"
                                                                                        name="monnify_mode" value="live"
                                                                                        class="form-check-input"
                                                                                        {{ isset($company_payment_setting['monnify_mode']) && $company_payment_setting['monnify_mode'] == 'live' ? 'checked="checked"' : '' }}>
                                                                                    {{ __('Live') }}
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="row gy-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="paypal_client_id"
                                                                class="col-form-label">{{ __('Public Key') }}</label>
                                                            <input type="text"
                                                                name="monnify_public_key"
                                                                id="monnify_public_key"
                                                                class="form-control"
                                                                value="{{ !isset($company_payment_setting['monnify_public_key']) || is_null($company_payment_setting['monnify_public_key']) ? '' : $company_payment_setting['monnify_public_key'] }}"
                                                                placeholder="{{ __('Public Key') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="monnify_secret_key"
                                                                class="col-form-label">{{ __('Secret Key') }}</label>
                                                            <input type="text"
                                                                name="monnify_secret_key"
                                                                id="monnify_secret_key"
                                                                class="form-control"
                                                                value="{{ !isset($company_payment_setting['monnify_secret_key']) || is_null($company_payment_setting['monnify_secret_key']) ? '' : $company_payment_setting['monnify_secret_key'] }}"
                                                                placeholder="{{ __('Secret Key') }}">
                                                            <div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="paypal_client_id"
                                                                class="col-form-label">{{ __('Contract Code') }}</label>
                                                            <input type="text"
                                                                name="monnify_contract_code"
                                                                id="monnify_contract_code"
                                                                class="form-control"
                                                                value="{{ !isset($company_payment_setting['monnify_contract_code']) || is_null($company_payment_setting['monnify_contract_code']) ? '' : $company_payment_setting['monnify_contract_code'] }}"
                                                                placeholder="{{ __('Contract Code') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="paypal_client_id"
                                                                class="col-form-label">{{ __('Source Account') }}</label>
                                                            <input type="text"
                                                                name="monnify_source_account"
                                                                id="monnify_contract_code"
                                                                class="form-control"
                                                                value="{{ !isset($company_payment_setting['monnify_source_account']) || is_null($company_payment_setting['monnify_source_account']) ? '' : $company_payment_setting['monnify_source_account'] }}"
