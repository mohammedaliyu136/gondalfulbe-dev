    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table datatable" id="pc-dt-render-column">
                    <thead>
                        <tr>
                            <th>{{ __('Batch Id') }}</th>
                            <th>{{__('Batch Type') }}</th>
...
<div class="tab-pane fade show active" id="payslip" role="tabpanel" aria-labelledby="payslip-tab">
    ...
    <div class="col-12">
        <div class="card">
            ...
            </div> <!-- Closing div for .card-header -->
                    ...
                    success: function(data) {
                        ...
                        function renderstatus(data, cell, row) {
                            if (data == 'Paid')
                                ...
                                return '<div class="badge status_badge bg-primary p-2 px-3 rounded"><a href="#" class="text-white">' +
                                    data + 'jjjj</a></div>';
                            else
                        ...
                        if (data.length > 0) {
                            $.each(data, function(indexInArray, valueOfElement) {
                                ...
                                //         '/' + datePicker +
                                //         '"  class="btn-sm btn btn-primary me-1" "data-bs-toggle="tooltip" title="{{__('Click To Paid')}}" data-original-title="{{__('Click To Paid')}}"><i class="ti ti-currency-naira"></i></a>  ';
                                // } else {
                                //     var clickToPaid = '';
                                // }
