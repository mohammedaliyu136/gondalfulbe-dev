...
<img src="{{ asset('storage/uploads/logo/seborelogo.png') }}" alt="Logo" class="img-fluid" style="max-width: 150px;">
    </div>
     <div class="">
    ...
    <div class="card-body">
        <div> 
            ...
            <h4 class="mb-3 f-w-600 text-center">{{ __('Please Sign in') }}</h4>
        </div>
