...
<div class="m-header main-logo text-center">
    <a href="#" class="b-brand">
        @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
            <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg" style="max-width: 10px; height: auto;">
        @else
            <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png') }}"
                alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg" style="max-width: 80px; height: auto;">
        @endif
    </a>
</div>
    ...
    <div class="navbar-content">
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if ($userPlan->pos == 1)
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Milk Collection') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <li
                                            ...
                                            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'reports-warehouse' || Request::segment(1) == 'reports-daily-purchase' || Request::segment(1) == 'reports-monthly-purchase' || Request::segment(1) == 'reports-daily-pos' || Request::segment(1) == 'reports-monthly-pos' || Request::segment(1) == 'reports-pos-vs-purchase' ? 'active dash-trigger' : '' }}"
                                                ...
                                                <ul class="dash-submenu">
                                                    <li
                                                        ...
                                                        <a class="dash-link"
                                                            href="{{ route('report.warehouse') }}">{{ __('Collection Centre Report') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('reports-daily-purchase') || request()->is('reports-monthly-purchase') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('report.daily.purchase') }}">{{ __('Collection Daily/Monthly Report') }}</a>
                                                    </li>
                                                    <!--<li-->
                    ...
                    @if (Gate::check('manage employee') || Gate::check('manage setsalary'))
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'HR' | \Auth::user()->type == 'IT Admin')
                                    <li
        ...
        @if (!empty($userPlan) &&  $userPlan->pos == 1)
            @if (Gate::check('manage vender'))
                <li
                    class="dash-item {{ Request::route()->getName() == 'vender.index' || Request::route()->getName() == 'vender.create' || Request::route()->getName() == 'vender.edit' || Request::route()->getName() == 'vender.show' ? ' active' : '' }}">
                    <a href="{{ route('vender.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-users"></i></span><span
                            class="dash-mtext">{{ __('Farmers') }}</span></a>
                </li>
            @endif
            @if (Gate::check('manage cooperative'))
                <li
                    class="dash-item {{ request()->is('cooperatives*') ? ' active' : '' }}">
                    <a href="{{ route('cooperatives.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-building-community"></i></span><span
            ...
            @if (Gate::check('manage warehouse') ||
                    ...
                    Gate::check('manage riders') ||
                    Gate::check('manage mc officers') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext">{{ __('Milk Collection') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul
                        ...
                        @can('manage purchase')
                            <li
                                ...
                                <a class="dash-link" href="{{ route('purchase.index') }}">{{ __('Purchase Milk') }}</a>
                            </li>
                        @endcan
                         @if (Gate::check('manage rider'))
                        <li
                            class="dash-item {{ Request::route()->getName() == 'rider.index' || Request::route()->getName() == 'rider.create' || Request::route()->getName() == 'rider.edit' || Request::route()->getName() == 'rider.show' ? ' active' : '' }}">
                            <a class="dash-link" href="{{ route('rider.index') }}">{{ __('Transport Crew') }}</a>
                        </li>
                        @endif
                        @if (Gate::check('manage mc officer'))
                        <li
                            class="dash-item {{ Request::route()->getName() == 'mcagent.index' || Request::route()->getName() == 'mcagent.create' || Request::route()->getName() == 'mcagent.edit' || Request::route()->getName() == 'mcagent.show' ? ' active' : '' }}">
                            <a class="dash-link" href="{{ route('mcagent.index') }}">{{ __('Milk Collection Center') }}</a>
                        </li>
                        @endif
                        @can('manage warehouse')
                            <li
                                class="dash-item {{ Request::route()->getName() == 'warehouse.index' || Request::route()->getName() == 'warehouse.show' ? ' active' : '' }}">
                                <a class="dash-link" href="{{ route('warehouse.index') }}">{{ __('Collection Centres') }}</a>
                            </li>
                        @endcan
                         @can('manage payment farmers')
                            <li class="dash-item {{ request()->is('payslip-farmer*') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('payslip-farmer.index') }}">{{ __('Payments') }}</a>
                                                </li>
        ...
        <!--------------------- Start Purchase Requisition System ----------------------------------->
        @can('manage requisition')
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'purchase-requisitions' ? ' active dash-trigger' : '' }}">
        <a href="#!" class="dash-link">
            <span class="dash-micon"><i class="ti ti-clipboard-list"></i></span>
            <span class="dash-mtext">{{ __('Requisitions') }}</span>
            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
        </a>
    <ul class="dash-submenu {{ Request::segment(1) == 'purchase-requisitions' ? 'show' : '' }}">
        @if (Gate::check('manage requisition'))
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.index') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.index') }}">{{ __('All Requisitions') }}</a>
        </li>
        @endif
        
         @if (Gate::check('manage service provider'))
                <li class="dash-item {{ Request::routeIs('service-provider.index') ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('service-provider.index') }}">{{ __('Service Providers') }}</a>
                </li>
        @endif
        @can('create requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.create') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.create') }}">{{ __('Create Requisition') }}</a>
        </li>
        @endcan
        @can('approve hod requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.stage.hod') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.stage.hod') }}">{{ __('Approval HOD') }}</a>
        </li>
        @endcan
        @can('approve audit requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.stage.internal-audit') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.stage.internal-audit') }}">{{ __('Approval Internal Audit') }}</a>
        </li>
        @endcan
        @can('approve accounts requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.stage.accounts') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.stage.accounts') }}">{{ __('Approval Accounts') }}</a>
        </li>
        @endcan
        @can('approve md requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.stage.md') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.stage.md') }}">{{ __('Approval GM') }}</a>
        </li>
        @endcan
        <!--<li class="dash-item {{ Request::routeIs('purchase-requisitions.stage.final') ? ' active' : '' }}">-->
        <!--    <a class="dash-link" href="{{ route('purchase-requisitions.stage.final') }}">{{ __('Final Approval') }}</a>-->
        <!--</li>-->
        @can('manage payment requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.payments') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.payments') }}">{{ __('Payments') }}</a>
        </li>
        @endcan
        @can('view report requisition')
        <li class="dash-item {{ Request::routeIs('purchase-requisitions.report') ? ' active' : '' }}">
            <a class="dash-link" href="{{ route('purchase-requisitions.report') }}">{{ __('Requisitions Report') }}</a>
        </li>
        @endcan
...
@endcan
        ...
        <!--------------------- Start Farm Management ----------------------------------->
                            @if (
                                    Gate::check('manage farm activity') ||
                                    Gate::check('manage farm field')
                                )
                            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'farm-fields' ? ' active dash-trigger' : '' }}">
                                <a href="#" class="dash-link">
                                    <span class="dash-micon"><i data-feather="map-pin"></i></span>
                                    <span class="dash-mtext">{{ __('Farm Manager') }}</span>
                                    <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                                </a>
                        
                                <ul class="dash-submenu collapse {{ Request::segment(2) == 'farm-fields' ? 'show' : '' }}">
                                    @can('manage farm fields')
                                    <li class="dash-item {{ Request::segment(2) == 'farm-fields' ? 'active' : '' }}">
                                        <a href="{{ route('farm-fields.index') }}" class="dash-link">
                                            <span class="dash-mtext">Farm Fields</span>
                                        </a>
                                    </li>
                                    @endcan
                                    @can('manage farm activity')
                                    <li class="dash-item {{ Request::route()->getName() == 'farm-activities.index' ? 'active' : '' }}">
                                        <a href="{{ route('farm-activities.index') }}" class="dash-link">
                                            Farm Activities
                                        </a>
                                    </li>
                                    @endcan
                                    @can('manage farm activity')
                                    <li class="dash-item {{ Request::route()->getName() == 'farm-activities.report.form' ? 'active' : '' }}">
                                        <a class="dash-link" href="{{ route('farm-activities.report.form') }}">
                                            {{ __('Farm Activity Report') }}
                                        </a>
                                    </li>
                                    @endcan
   ...
   @can('manage assets')
    <li class="dash-item {{ request()->is('account-assets*') ? 'active' : '' }}">
        <a href="{{ route('account-assets.index') }}" class="dash-link">
            ...
            <span class="dash-mtext">{{ __(' Company Assets ') }}</span>
        </a>
    </li>
@endcan

@if (Gate::check('manage inventory') || Gate::check('add stock inventory') || Gate::check('issue stock inventory'))
<li class="dash-item dash-hasmenu 
    {{ request()->is('inventories*') || request()->is('inventory-stock*') || request()->is('inventory-issues*') ? 'active' : '' }}">
    ...
    <ul class="dash-submenu">
        ...
        {{-- Inventory Stock --}}
        <li class="dash-item {{ request()->is('inventory-stock*') ? 'active' : '' }}">
            <a href="{{ route('inventories.index') }}" class="dash-link">{{ __('Inventory Stock') }}</a>
        </li>
        @can('issue stock inventory')
        {{-- Issue Report --}}
        <li class="dash-item {{ request()->is('inventory-issues*') ? 'active' : '' }}">
            <a href="{{ route('inventory-issues.report') }}" class="dash-link">{{ __('Issue Report') }}</a>
        </li>
        @endcan
    </ul>
</li>
            ...
            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'support' ? 'active' : '' }}">
                <a href="{{ route('support.index') }}" class="dash-link">
                    <span class="dash-micon"><i class="ti ti-headphones"></i></span><span
                        class="dash-mtext">{{ __('Ticket Support ') }}</span>
                </a>
            </li>
            <!--<li-->
