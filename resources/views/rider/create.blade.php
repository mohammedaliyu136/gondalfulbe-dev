{{ Form::open(array('url' => 'rider', 'method' => 'post', 'class' => 'needs-validation', 'novalidate', 'enctype' => 'multipart/form-data')) }}
<div class="modal-body">

    <h6 class="sub-title">{{__('New Rider Info')}}</h6>
    <div class="row">
       ...
       <div class="col-lg-4 col-md-4 col-sm-6">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                {{ Form::label('user_type', __('Transporter Type'), ['class' => 'form-label']) }}<x-required></x-required>
                {{ Form::select('user_type', ['rider' => 'Rider', 'driver' => 'Driver'], null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Select transporter type')]) }}
            </div>
        </div>
       <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    {{ Form::select('state_id', $state->pluck('name', 'id'), null, ['class' => 'form-control', 'placeholder' => __('Select State'), 'id' => 'state-select']) }}
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    {{ Form::select('lga_id', [], null, ['class' => 'form-control', 'placeholder' => __('Select LGA'), 'id' => 'lga-select']) }}
                </div>
            </div>
        </div>
