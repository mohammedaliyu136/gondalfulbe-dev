<div class="card shadow-lg border-0">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                <tbody>
                    <tr>
                        <th>Amount:</th>
                        <td><h4 class="text-success">₦{{ number_format($totalSum, 2, '.', ',') }}</h4></td>
                    </tr>
        ...
        <form id="reversal-form" action="{{ route('purchase-requisitions.process.approval') }}" method="POST">
            @csrf
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-primary" id="submit-button" >
                    <span id="button-text">Approve Payment</span>
