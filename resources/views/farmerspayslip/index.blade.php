...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __(' farmers payslip') }}</li>
@endsection
...
<div class="tab-content mt-3" id="tabContent">
    ...
    <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2">
                ...
                <div class="col-auto float-start mt-4">
                    <div class="p-4">
                        ...
                        <p class="card-text mb-0">Farmers Count</p>
                        <h6 class="report-text mb-0">{{$farmers_with_positive_balance}}</h6>
                    </div>
                </div>
                <!-- Float Right -->
        ...
        <form id="collectionCenterForm" method="POST" action="{{ route('payslip.farmer.multiplecenter.bulk_pay_store') }}">
    @csrf
    <div class="row">
                    ...
                    <div class="card-body">
                        <!-- Checkbox at Top Right -->
                            <div class="col-auto text-end">
                                <input type="checkbox" name="collection_center[]" value="{{ $result->collection_centre }}">
                            </div>
                        ...
                        <div class="row align-items-center justify-content-between mt-2">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h6 class="m-0">
                                           <a href="#" 
                                           data-size="lg" 
                                           data-url="{{ route('payslipitem.center.list', ['center' => $result->collection_centre]) }}" 
                                           data-ajax-popup="true" 
                                           data-title="{{ $result->collection_centre }}" 
                                           data-bs-toggle="tooltip" 
                                           title="{{ __('View list') }}" 
                                           class="dashboard-link">
                                           Vendors with Positive Balance
                                        </a>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="col-auto text-end">
                                ...
                                <small class="text-muted">Vendors Count</small>
                            </div>
                        </div>
                    </div>
                </div>
