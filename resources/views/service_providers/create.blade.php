{{ Form::open(array('url' => 'service-provider', 'method' => 'post', 'class' => 'needs-validation', 'novalidate', 'enctype' => 'multipart/form-data')) }}
<div class="modal-body">

    <h6 class="sub-title">{{__('New Service Provider Info')}}</h6>
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                {{Form::number('contact',null,array('class'=>'form-control' , 'placeholder' => __('Enter Phone No:')))}} --}}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{Form::textarea('billing_address',null,array('class'=>'form-control','rows'=>3 , 'required'=>'required',  'placeholder' => __('Enter Address')))}}
            </div>
        </div>
