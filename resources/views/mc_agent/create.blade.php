{{ Form::open(array('url' => 'mcagent', 'method' => 'post', 'class' => 'needs-validation', 'novalidate', 'enctype' => 'multipart/form-data')) }}
<div class="modal-body">

    <h6 class="sub-title">{{__('New MC Agent Info')}}</h6>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    {{ Form::select('collection_centre', $warehouses->pluck('name', 'id'), null, ['class' => 'form-control', 'required'=>'required', 'placeholder' => __('Select Collection Centre')]) }}
                </div>
            </div>
