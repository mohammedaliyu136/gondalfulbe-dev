    ...
    @if(!empty($employee))
        <div class="float-end mt-3 m-2">
            @can('edit employee')
                ...
                <a href="{{ route('employee.idcard.print', $employee->id) }}" 
                   class="btn btn-sm btn-secondary" 
                   target="_blank">
                   <i class="ti ti-printer"></i> Print ID Card
                </a>
                        ...
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                ...
                                <div class="col-md-6">
                                        <div class="image-container text-center" style="max-width: 200px; overflow: hidden;">
                                            @if ($employee->passport)
                                                ...
                                                <img src="{{ asset('public/uploads/employees_passport/' . $employee->passport) }}" alt="{{ $employee->name }}" class="img-fluid rounded" style="max-width: 100%; height: auto;">
                                            @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold">{{__('Employee Number')}} : </strong>
