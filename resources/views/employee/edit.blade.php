            ...
            <div class="card emp_details">
                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <div class="form-group col-md-12">
                            {!! Form::label('employee_number', __('Employee Number'),['class'=>'form-label']) !!}
                            {!! Form::text('employee_number',$employee->number, ['class' => 'form-control','placeholder'=>'E.g. SIFL/ADM/1234']) !!}
                    </div>
                    <div class="form-group">
                                    ...
                                    <select id="bank" name="bank_identifier_code" class="form-control select2" required>
                                        ...
                                        @foreach ($bankList as $bank)
                                            <option value="{{ $bank['code'] }}" data-name="{{ $bank['name'] }}"
                                                @if(isset($employee) && $employee->bank_identifier_code == $bank['code']) selected @endif>
                                                {{ $bank['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
