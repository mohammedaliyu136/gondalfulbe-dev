...
use App\Http\Controllers\McAgentController;
...
use App\Http\Controllers\PaySlipFarmerController;
...
use App\Http\Controllers\RiderTripController;
...
Route::post('/inventory-stock', [InventoryStockController::class, 'store'])->name('inventory-stock.store');
    ...
    Route::get('inventory-issues/{inventory}/create', [InventoryIssueController::class, 'create'])->name('inventory-issues.create');
    Route::post('inventory-issues/store', [InventoryIssueController::class, 'store'])->name('inventory-issues.store');
    Route::get('inventory-issues/report', [InventoryIssueController::class, 'report'])->name('inventory-issues.report');
    Route::get('/inventory/{inventory}/quantity', [InventoryController::class, 'getQuantity'])
    ->name('inventory.getQuantity');

    Route::get('/inventories/{inventory}/add-stock', [InventoryStockController::class, 'create'])->name('inventories.addStockForm');  




//Location
Route::get('/states/{state}/lgas', [LocationController::class, 'getLgas']);
...
//===========================================================Monnify==================================================================================
Route::post('/retainer-pay-with-monnify', [MonnifyPaymentController::class, 'RetainerPayWithMonnify'])->name('retainer.pay.with.monnify')->middleware(['XSS:customer']);
Route::get('/retainer/monnify/{retainer_id}/{amount}/{pay_id}', [App\Http\Controllers\MonnifyPaymentController::class, 'getRetainerPaymentStatus'])->name('retainer.monnify')->middleware(['XSS:customer']);

Route::post('/invoice-pay-with-monnify', [MonnifyPaymentController::class, 'invoicePayWithMonnify'])->name('invoice.pay.with.monnify')->middleware(['XSS', 'revalidate']);
Route::get('/invoice/monnify/{invoice_id}/{amount}/{pay_id}', [App\Http\Controllers\MonnifyPaymentController::class, 'getInvoicePaymentStatus'])->name('invoice.monnify')->middleware(['XSS', 'revalidate']);
//=====================================================================================================================================================

    Route::get('employee/verify/{uuid}', [EmployeeController::class, 'showVerify'])
    ->name('employee.verify.show');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
     ...
     //Rider
       Route::group(
        ...
        function () {
            // Rider resource routes
            Route::resource('rider', RiderController::class); 
    
               
                Route::prefix('rider-payslips')->name('rider.payslips.')->group(function () {
                Route::get('bulk-payment/home', [RiderController::class, 'bulkPaymentHome'])->name('home');
                Route::get('bulk-payment/lga-list/{lga}', [RiderController::class, 'lgaWithBalance'])->name('lgalist');
                Route::post('bulk-payment/lga-list/bulk_pay_store', [RiderController::class, 'lgaBulkPayStore'])->name('lga.bulk_pay_store');
               // Route::get('bulk-payment/create', [RiderController::class, 'bulkPaymentCreate'])->name('create');
                //Route::get('bulk-payment/edit/{id}', [RiderController::class, 'bulkPaymentEdit'])->name('edit');
                Route::post('bulk-payment/store', [RiderController::class, 'bulkPaymentStore'])->name('store');
                //Route::put('bulk-payment/update/{payslip}', [RiderController::class, 'bulkPaymentUpdate'])->name('update');
                Route::get('bulk-payment/show/{id}', [RiderController::class, 'bulkPaymentShow'])->name('show');  
                //Route::delete('bulk-payment/delete/{payslip}', [RiderController::class, 'paymentBatchItemtDelete'])->name('delete');
                Route::get('bulk-payment/lga/lga-list/{lga}', [RiderController::class, 'lgaWithBalance'])->name('lga.list');
                Route::post('bulk-payment/lga/bulk_pay_store', [RiderController::class, 'lgaBulkPayStore'])->name('lga.bulk_pay_store');
                Route::post('bulk-payment/multiplecenter/bulk_pay_store', [RiderController::class, 'multipleLgaBulkPayStore'])->name('multiplecenter.bulk_pay_store');
                
                Route::get('bulk-payment/approve/{id}', [RiderController::class, 'approvePayment'])->name('approvepayment');
                Route::get('bulk-payment/initialise/{id}', [RiderController::class, 'initialisePayment'])->name('initialisepayment');
                Route::post('bulk-payment/resend-token', [RiderController::class, 'resendToken'])->name('resendtoken');
                Route::get('bulk-payment/revalidate/{id}', [RiderController::class, 'revalidatePaylip'])->name('revalidate');
                Route::post('bulk-payment/authorise', [RiderController::class, 'authorisePayment'])->name('authorisepayment');
                Route::get('bulk-payment/reversal/page/{id}', [RiderController::class, 'reversPaylipPage'])->name('reverse.page');
                Route::post('bulk-payment/process-reversal', [RiderController::class, 'processReversal'])->name('process.reversal');
                
                Route::get('/', [RiderController::class, 'PayslipIndex'])->name('index');
            });
    ...
    //Rder trips
    Route::prefix('rider-trips')->name('rider-trips.')->group(function () {
        Route::get('/', [RiderTripController::class, 'index'])->name('index');             // List all trips
        Route::get('create/{encryptedRiderId}', [RiderTripController::class, 'create'])->name('create');    // Show create form
        Route::post('/', [RiderTripController::class, 'store'])->name('store');            // Store new trip
        Route::get('{id}/edit', [RiderTripController::class, 'edit'])->name('edit');       // Show edit form
        Route::put('{id}', [RiderTripController::class, 'update'])->name('update');        // Update trip
        Route::get('{id}', [RiderTripController::class, 'show'])->name('show');            // Show single trip
        Route::delete('{id}', [RiderTripController::class, 'destroy'])->name('destroy');   // Delete trip
        Route::get('validate/{encryptedTripId}', [RiderTripController::class, 'validateTrip'])->name('validate-trip');
        Route::post('validate/process', [RiderTripController::class, 'processValidate'])->name('process-validate'); 
    });
    ...
    //Milk Collection Agents
       Route::group(
        ...
        function () {
            ...
            Route::resource('mcagent', McAgentController::class)->parameters([
                'mcagent' => 'agent'  // This maps the route parameter to the method parameter
            ]);
            
               
                Route::prefix('mcagent-payslips')->name('mcagent.payslips.')->group(function () {
                    Route::get('bulk-payment/create', [McAgentController::class, 'bulkPaymentCreate'])->name('create');
                    Route::get('bulk-payment/edit/{id}', [McAgentController::class, 'bulkPaymentEdit'])->name('edit');
                    Route::post('bulk-payment/store', [McAgentController::class, 'bulkPaymentStore'])->name('store');
                    Route::put('bulk-payment/update/{payslip}', [McAgentController::class, 'bulkPaymentUpdate'])->name('update');
                    Route::get('bulk-payment/show/{id}', [McAgentController::class, 'bulkPaymentShow'])->name('show');  
                    Route::delete('bulk-payment/delete/{payslip}', [McAgentController::class, 'paymentBatchItemtDelete'])->name('delete');
                    
                    Route::get('bulk-payment/approve/{id}', [McAgentController::class, 'approvePayment'])->name('approvepayment');
                    Route::get('bulk-payment/initialise/{id}', [McAgentController::class, 'initialisePayment'])->name('initialisepayment');
                    Route::post('bulk-payment/resend-token', [McAgentController::class, 'resendToken'])->name('resendtoken');
                    Route::get('bulk-payment/revalidate/{id}', [McAgentController::class, 'revalidatePaylip'])->name('revalidate');
                    Route::post('bulk-payment/authorise', [McAgentController::class, 'authorisePayment'])->name('authorisepayment');
                    Route::get('bulk-payment/reversal/page/{id}', [McAgentController::class, 'unDefine'])->name('reverse.page');
                    Route::get('bulk-payment/reversal/page/{id}', [McAgentController::class, 'unDefine'])->name('reverse.page');
                    
                    Route::get('/', [McAgentController::class, 'PayslipIndex'])->name('index');
            });
    ...
    Route::group(
        ...
        function () {
            Route::resource('service-provider', ServiceProvidersController::class);
        }
    );
    ...
    Route::get('employee/{id}/id-card-print', [EmployeeController::class, 'printIdCard'])->name('employee.idcard.print');
    ...
    Route::get('payslip/{id}/showpayslip', [PaySlipController::class, 'showPayslip'])->name('payslip.showpayslip')->middleware(['auth', 'XSS']);
    Route::get('payslip/payment/approve/{id}', [PaySlipController::class, 'approvePayment'])->name('payslip.approvepayment')->middleware(['auth', 'XSS']);
    Route::post('payslip/payment/process-approval', [PaySlipController::class, 'processApproval'])->name('payslip.process.approval')->middleware(['auth', 'XSS']);
    Route::get('payslip/payment/innitialise/{id}', [PaySlipController::class, 'initialisePayment'])->name('payslip.initialisepayment')->middleware(['auth', 'XSS']);
    Route::post('payslip/payment/resend-token', [PaySlipController::class, 'resendToken'])->name('payslip.resendtoken')->middleware(['auth', 'XSS']);
    Route::post('payslip/payment/authorise', [PaySlipController::class, 'authorisePayment'])->name('payslip.authorisepayment')->middleware(['auth', 'XSS']);
    Route::get('payslip/payment/revalidate-payslip/{batchRef}', [PaySlipController::class, 'revalidatePaylip'])->name('payslip.bulktransfer.revalidate')->middleware(['auth', 'XSS']);
    Route::get('payslip/payment/regenerate-failed-transactions/{batchRef}', [PaySlipController::class, 'regenerateFailedTransactions'])->name('payslip.bulktransfer.regenerate')->middleware(['auth', 'XSS']);
    Route::resource('payslip', PaySlipController::class)->middleware(['auth', 'XSS']);
    
    //======================================Farmer Payslip===============================================================================

    Route::get('payslip-farmer/bulk_pay_create', [PaySlipFarmerController::class, 'bulk_pay_create'])->name('payslip.farmer.bulk_pay_create')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/center/bulk_pay_create', [PaySlipFarmerController::class, 'centerBulkPayCreate'])->name('payslip.farmer.center.bulk_pay_create')->middleware(['auth', 'XSS']);
    Route::post('payslip-farmer/center/bulk_pay_store', [PaySlipFarmerController::class, 'centerBulkPayStore'])->name('payslip.farmer.center.bulk_pay_store')->middleware(['auth', 'XSS']);
    Route::post('payslip-farmer/multiplecenter/bulk_pay_store', [PaySlipFarmerController::class, 'multipleCenterBulkPayStore'])->name('payslip.farmer.multiplecenter.bulk_pay_store')->middleware(['auth', 'XSS']);
    Route::post('payslip-farmer/bulkpayment/{date}', [PaySlipFarmerController::class, 'bulkpayment'])->name('payslip.farmer.bulkpayment')->middleware(['auth', 'XSS']);
    Route::post('payslip-farmer/search_json', [PaySlipFarmerController::class, 'search_json'])->name('payslip.farmer.search_json')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/{id}/show', [PaySlipFarmerController::class, 'showPayslip'])->name('payslip.farmer.show')->middleware(['auth', 'XSS']);
    Route::get('payslipitem-farmer/{id}/show', [PaySlipFarmerController::class, 'showPayslipItems'])->name('payslipitem.farmer.show')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/approve/{id}', [PaySlipFarmerController::class, 'approvePayment'])->name('payslipitem.farmer.approvepayment')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/innitialise/{id}', [PaySlipFarmerController::class, 'initialisePayment'])->name('payslipitem.farmer.initialisepayment')->middleware(['auth', 'XSS']);
    Route::post('payslip-farmer/payment/authorise', [PaySlipFarmerController::class, 'authorisePayment'])->name('payslipitem.farmer.authorisepayment')->middleware(['auth', 'XSS']);
    //--------------------[TODO]--------------CREATE MONNIFY CONTROLLER TO HANDLE BELLOW ACTIONS-------------------------------------------
    Route::post('payslip-farmer/payment/resend-token', [PaySlipFarmerController::class, 'resendToken'])->name('payslipitem.farmer.resendtoken')->middleware(['auth', 'XSS']);
    Route::post('payslip-farmer/payment/validate-account', [PaySlipFarmerController::class, 'validateBankAccount'])->name('payslipitem.validate.account')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/get-bulk-transactions', [PaySlipFarmerController::class, 'getBulkTransferTransactions'])->name('payslipitem.bulktransfer.transactions')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/view-bulk-transactions-payments', [PaySlipFarmerController::class, 'getBulkTransactionsPayments'])->name('payslipitem.bulktransfer.viewpayments')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/collection-center-list/{center}', [PaySlipFarmerController::class, 'collectionCenterWithBalance'])->name('payslipitem.center.list')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/update-payslip-items/{batchRef}', [PaySlipFarmerController::class, 'updatePaylipItems'])->name('payslipitem.bulktransfer.updateitems')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/revalidate-payslip/{batchRef}', [PaySlipFarmerController::class, 'revalidatePaylipItems'])->name('payslipitem.bulktransfer.revalidate')->middleware(['auth', 'XSS']);
    Route::get('payslip-farmer/payment/reversed-payslip-page/{id}', [PaySlipFarmerController::class, 'reversPaylipPage'])->name('payslipitem.reverse.page')->middleware(['auth', 'XSS']);
    ...
    //-----------------------------------------Monnify-----------------------------------------------------------------------------
    Route::post('/plan-pay-with-monnify', [MonnifyPaymentController::class, 'planPayWithMonnify'])->name('plan.pay.with.monnify')->middleware(['auth', 'XSS',]);
    Route::get('/plan/monnify/{pay_id}/{plan_id}', [MonnifyPaymentController::class, 'getPaymentStatus'])->name('plan.monnify')->middleware(['auth', 'XSS',]);
    // -----------------------------------------------------------------------------------------------------------------------------
...
// Route::post('import/vender', [VenderController::class, 'import'])->name('vender.import');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('purchase/warehouse/vendors', [PurchaseController::class, 'warehouseVendors'])->name('purchase.warehouse.vendors');
        }
...
Route::middleware(['auth', 'XSS', 'revalidate'])->group(function () {
    ...
    Route::get('/purchase-requisitions/{id}/edit', [PurchaseRequisitionController::class, 'edit'])->name('purchase-requisitions.edit');
    Route::get('/purchase-requisitions/{id}/show', [PurchaseRequisitionController::class, 'show'])->name('purchase-requisitions.show');
    Route::get('/purchase-requisitions/{id}/view/{stage}', [PurchaseRequisitionController::class, 'view'])
    ->name('purchase-requisitions.view');
    Route::put('/purchase-requisitions/{id}', [PurchaseRequisitionController::class, 'update'])->name('purchase-requisitions.update');
    Route::delete('/purchase-requisitions/{id}', [PurchaseRequisitionController::class, 'destroy'])->name('purchase-requisitions.destroy');
    Route::get('/purchase-requisitions/report', [PurchaseRequisitionController::class, 'report'])->name('purchase-requisitions.report');

    // Approval Stages Routes
    Route::get('/purchase-requisitions/stage/hod', [PurchaseRequisitionController::class, 'approvalHOD'])->name('purchase-requisitions.stage.hod');
    Route::get('/purchase-requisitions/stage/internal-audit', [PurchaseRequisitionController::class, 'approvalInternalAudit'])->name('purchase-requisitions.stage.internal-audit');
    Route::get('/purchase-requisitions/stage/accounts', [PurchaseRequisitionController::class, 'approvalAccounts'])->name('purchase-requisitions.stage.accounts');
    Route::get('/purchase-requisitions/stage/md', [PurchaseRequisitionController::class, 'approvalMD'])->name('purchase-requisitions.stage.md');
    Route::get('/purchase-requisitions/stage/final', [PurchaseRequisitionController::class, 'finalApproval'])->name('purchase-requisitions.stage.final');
    ...
    Route::post('/purchase-requisitions/{id}/hod-approve', [PurchaseRequisitionController::class, 'hodApprove'])->name('purchase-requisitions.hod-approve');
    Route::post('/purchase-requisitions/{id}/internal-audit-approve', [PurchaseRequisitionController::class, 'internalAuditApprove'])->name('purchase-requisitions.internal-audit-approve');
    Route::post('/purchase-requisitions/{id}/accounts-approve', [PurchaseRequisitionController::class, 'accountsApprove'])->name('purchase-requisitions.accounts-approve');
    
    // Payment PR
    Route::get('/purchase-requisitions/payments', [PurchaseRequisitionController::class, 'payment'])->name('purchase-requisitions.payments');
    Route::post('/purchase-requisitions/bulk-payment-store', [PurchaseRequisitionController::class, 'bulkPaymentStore'])->name('purchase-requisitions.bulk_payment_store');
    Route::post('/purchase-requisitions/{id}/cancel-payment', [PurchaseRequisitionController::class, 'cancelPayment'])->name('purchase-requisitions.cancel-payment');
    Route::get('purchase-requisitions/{id}/showpayslip', [PurchaseRequisitionController::class, 'showPayslip'])->name('purchase-requisitions.showpayslip')->middleware(['auth', 'XSS']);
    Route::get('purchase-requisitions/payment/approve/{id}', [PurchaseRequisitionController::class, 'approvePayment'])->name('purchase-requisitions.approvepayment')->middleware(['auth', 'XSS']);
    Route::post('purchase-requisitions/payment/process-approval', [PurchaseRequisitionController::class, 'processApproval'])->name('purchase-requisitions.process.approval')->middleware(['auth', 'XSS']);
    Route::get('purchase-requisitions/payment/innitialise/{id}', [PurchaseRequisitionController::class, 'initialisePayment'])->name('purchase-requisitions.initialisepayment')->middleware(['auth', 'XSS']);
    Route::get('purchase-requisitions/payment/revalidate-payslip/{batchRef}', [PurchaseRequisitionController::class, 'revalidatePaylip'])->name('purchase-requisitions.bulktransfer.revalidate')->middleware(['auth', 'XSS']);
    Route::post('purchase-requisitions/payment/resend-token', [PurchaseRequisitionController::class, 'resendToken'])->name('purchase-requisitions.resendtoken')->middleware(['auth', 'XSS']);
    Route::post('purchase-requisitions/payment/authorise', [PurchaseRequisitionController::class, 'authorisePayment'])->name('purchase-requisitions.authorisepayment')->middleware(['auth', 'XSS']);

});

// Farm Management

Route::get('/farm-activities/report/export', [FarmActivityController::class, 'exportReport'])->name('farm-activities.report.export');



Route::prefix('farm-activities')->group(function () {
    Route::get('report', [FarmActivityController::class, 'reportForm'])->name('farm-activities.report.form');
    Route::post('report', [FarmActivityController::class, 'generateReport'])->name('farm-activities.report.generate');
});
...
Route::prefix('farm-fields')->middleware('auth')->group(function () {
    Route::get('/', [FarmFieldController::class, 'index'])->name('farm-fields.index');
    Route::get('/create', [FarmFieldController::class, 'create'])->name('farm-fields.create');
    Route::post('/', [FarmFieldController::class, 'store'])->name('farm-fields.store');
    Route::get('/{ids}', [FarmFieldController::class, 'show'])->name('farm-fields.show');
    Route::get('/{ids}/edit', [FarmFieldController::class, 'edit'])->name('farm-fields.edit');
    Route::put('/{ids}', [FarmFieldController::class, 'update'])->name('farm-fields.update');
    Route::delete('/{ids}', [FarmFieldController::class, 'destroy'])->name('farm-fields.destroy');
});
