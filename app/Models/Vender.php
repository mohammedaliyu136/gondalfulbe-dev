...
class Vender extends Authenticatable
{
    ...
    {
        return $this->belongsTo(\Modules\Cooperatives\Models\Cooperative::class, 'cooperative_id');
    }
    ...
    /**
     * Get a list of venders with a positive balance.
     *
     * @return \Illuminate\Database\Eloquent\Collection
     */
    public static function getVendersWithPositiveBalance()
    {
