...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function department()
    {
        return $this->hasOneThrough(
            Department::class,
            Employee::class,
            'id', // Foreign key in employees table that links to users table
            'id', // Foreign key in departments table
            'id', // Local key in users table
            'department_id' // Local key in employees table
        );
    }
            ...
            'otp_verification' => [
                    ...
                    'lang' => [
                        'en' => '<p><strong>Hi</strong> {user_name},</p>
                                 ...
                                 <p>{company_name}</p>',
                        'fr' => '<p><strong>Salut</strong> {user_name},</p>
                                 <p>Votre code OTP pour la vérification est: <strong>{otp_code}</strong></p>
                                 <p>Ce code expirera dans {otp_expiry} minutes.</p>
                                 <p><strong>Cordialement,</strong></p>
                                 <p>{company_name}</p>',
                        'es' => '<p><strong>Hola</strong> {user_name},</p>
                                 <p>Su código OTP para verificación es: <strong>{otp_code}</strong></p>
                                 <p>Este código expirará en {otp_expiry} minutos.</p>
                                 <p><strong>Saludos cordiales,</strong></p>
                                 <p>{company_name}</p>',
                        'de' => '<p><strong>Hallo</strong> {user_name},</p>
                                 <p>Ihr OTP zur Überprüfung lautet: <strong>{otp_code}</strong></p>
                                 <p>Dieser Code läuft in {otp_expiry} Minuten ab.</p>
                                 <p><strong>Mit freundlichen Grüßen,</strong></p>
                                 <p>{company_name}</p>',
                        'ar' => '<p><strong>مرحبا</strong> {user_name},</p>
                                 <p>رمز OTP الخاص بك للتحقق هو: <strong>{otp_code}</strong></p>
                                 <p>سينتهي هذا الرمز خلال {otp_expiry} دقائق.</p>
                                 <p><strong>تحياتي،</strong></p>
                                 <p>{company_name}</p>',
                        'zh' => '<p><strong>你好</strong> {user_name},</p>
                                 <p>您的验证码 (OTP) 为: <strong>{otp_code}</strong></p>
                                 <p>该验证码将在 {otp_expiry} 分钟后过期。</p>
                                 <p><strong>敬上,</strong></p>
                                 <p>{company_name}</p>',
                    ],
                ],
