...
{{ Form::open(['url' => $action, 'method' => isset($cost) ? 'PUT' : 'POST', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate' => true]) }}
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary">
        {{ isset($cost) ? __('Update') : __('Save as Draft') }}
    </button>
</div>
