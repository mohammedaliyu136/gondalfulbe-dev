...
<div class="row justify-content-center">
    <div class="col-md-7">
        <div class="card">
            <div class="card-header"><h5 class="mb-0">{{ __('Record Stock In') }}</h5></div>
            <div class="card-body">
                <form method="POST" action="{{ route('oss-inventory.store-in') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="product_id" class="form-select @error('product_id') is-invalid @enderror" required>
                                ...
                                <option value="{{ $p->id }}" @selected(old('product_id') == $p->id)>{{ $p->name }} ({{ $p->unit }})</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="reference" class="form-control" placeholder="{{ __('Supplier / Invoice #') }}"
                                   value="{{ old('reference') }}">
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-success">{{ __('Record Stock In') }}</button>
